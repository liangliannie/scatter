...
def parse():
    ...
    parser.add_argument('--training-file', type=str, dest='training_file', default="/home/liang/Desktop/scatter_dl2/data_pkl/",
                        help='Path to numpy file containing the training data')
    parser.add_argument('--test-file', type=str, dest='test_file', default="/home/liang/Desktop/scatter_dl2/data_pkl/",
    ...
    parser.add_argument('--batch-size', type=int, dest='batch_size', default=12,
